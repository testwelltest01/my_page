...
- **Type:** **Noto Serif KR** keeps the warm, grounded display tone for Korean headings. **Pretendard** is used for body, navigation, labels, and controls so Korean text stays crisp and readable. Tracking is neutral for Korean copy, with relaxed body line-height for comfortable scanning.
